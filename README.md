...
This is the finished code for the final assessment project for Udacity's React & Redux course.
...
To run the project cd to the project directory and run the following commands:
